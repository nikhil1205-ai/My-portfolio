import profilePhoto from '@/assets/my_image3.png';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left relative z-10">
            ...
            <h2 className="font-heading text-xl md:text-2xl text-brown-dark mb-4 opacity-0 animate-fade-up stagger-2">
              Data Scientist | ML & AI Enthusiast | Full Stack Developer
            </h2>

            <p className="text-body max-w-lg mx-auto lg:mx-0 mb-8 opacity-0 animate-fade-up stagger-3">
              I’m Nikhil Dangi, a passionate Data Scientist and Full Stack Developer with a strong foundation in Machine Learning, Deep Learning, Artificial Intelligence, and Web Development..
            </p>

            {/* ✅ FIXED BUTTONS (opacity-0 removed) */}
